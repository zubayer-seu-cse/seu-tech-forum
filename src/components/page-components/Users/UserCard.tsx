...
export default function UserCard({ img }: any) {
    return (
        <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="flex flex-col items-center pb-10">
                <div className='w-24 h-24 mb-3 rounded-full shadow-lg overflow-hidden flex items-center' >
                    <img className="scale-[1.5]" src={img} alt="image" />
                </div>
