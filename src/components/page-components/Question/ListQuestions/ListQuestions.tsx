            ...
            <div className='my-24' >
                <div className='flex items-center'>
                    <form className="w-[60%] mx-auto">
                        <h1 className="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-3xl dark:text-white">Ask the Community!</h1>
                        <div className="mb-5">
                            <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Write Your Question</label>
